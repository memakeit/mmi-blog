...
class Controller_MMI_Blog_Post extends MMI_Template
{
	...
	public function action_index()
	{
		...
		{
			$view->set('comments', $this->_get_comments($post));
			if ($this->_allow_pingbacks OR $this->_allow_trackbacks)
			{
				$view->set('trackbacks', $this->_get_trackbacks($post));
			}
		}
	...
	protected function _get_comments($post)
	{
	...
	protected function _get_trackbacks($post)
	{
		$route = Route::get('mmi/blog/hmvc')->uri(array
		(
