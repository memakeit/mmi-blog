...
class Model_WP_Options extends Jelly_Model
{
	 ...
	 */
	protected static $_table_name = 'wp3_options';
	 ...
	 * @return	mixed
	 */
	public static function select_by_option_id($option_ids, $blog_id = 0, $columns = NULL, $as_array = TRUE, $array_key = NULL, $limit = NULL)
	{
		$where_parms['blog_id'] = $blog_id;
		if (MMI_Util::is_set($option_ids))
		{
			$where_parms['option_id'] = $option_ids;
		}
