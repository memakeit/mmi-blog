...
class Model_WP_PostMeta extends Jelly_Model
{
	 ...
	 */
	protected static $_table_name = 'wp3_postmeta';
	 ...
	 * @return	mixed
	 */
	public static function select_by_meta_id($meta_ids, $columns = NULL, $as_array = TRUE, $array_key = NULL, $limit = NULL)
	{
		$where_parms = array();
		if (MMI_Util::is_set($meta_ids))
		{
			$where_parms['meta_id'] = $meta_ids;
		}
