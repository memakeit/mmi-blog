...
abstract class Kohana_MMI_Blog_Post extends MMI_Blog_Core
{
	...
	abstract public function get_popular($reload_cache = NULL);
	abstract public function get_posts($ids = NULL, $reload_cache = NULL);
	abstract public function get_recent($reload_cache = NULL);
	abstract public function get_related($id, $reload_cache = NULL);
